...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x = 100, y = 10, width = 500, height = 360)
        
        self.panel2 = tk.Label(self.root) # initialize image panel
        self.panel2.place(x = 400, y = 10, width = 275, height = 365)
        ...
        self.panel3.place(x = 500, y = 410)

        self.T1 = tk.Label(self.root)
        self.T1.place(x = 10, y = 410)
        self.T1.config(text = "Character :", font = ("Courier", 30, "bold"))

        self.panel4 = tk.Label(self.root) # Word
        self.panel4.place(x = 220, y = 450)

        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 450)
        self.T2.config(text = "Word :", font = ("Courier", 30, "bold"))

        self.panel5 = tk.Label(self.root) # Sentence
        self.panel5.place(x = 350, y = 505)

        self.T3 = tk.Label(self.root)
        #self.T3.place(x = 10, y = 645)
        self.T3.place(x = 10, y = 505)
        self.T3.config(text = "Sentence :",font = ("Courier", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 25, y = 555)
        self.T4.config(text = "Suggestions :", fg = "blue", font = ("Courier", 30, "bold"))
        self.speak = tk.Button(self.root)
        self.speak.place(x=600, y=505)
        self.speak.config(text="Speak", font=("Courier", 20), wraplength=100, command=self.speak_fun)

        self.clear = tk.Button(self.root)
        self.clear.place(x=700, y=505)
        self.clear.config(text="Clear", font=("Courier", 20), wraplength=100, command=self.clear_fun)

        self.bt1 = tk.Button(self.root, command = self.action1, height = 0, width = 0)
        self.bt1.place(x = 30, y = 600)

        self.bt2 = tk.Button(self.root, command = self.action2, height = 0, width = 0)
        self.bt2.place(x = 225, y = 600)

        self.bt3 = tk.Button(self.root, command = self.action3, height = 0, width = 0)
        self.bt3.place(x = 425, y = 600)
